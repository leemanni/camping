...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index5.jsp">캠핑장 리뷰 사이트</a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="lecture">지역 1</a></li>
						<li><a href="lecture_2">지역 2</a></li>
						<li><a href="lecture_3">지역 3</a></li>
					</ul>
				</li>
			</ul>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<ul class="lost-group">
				...
				<a href="lecture_3" class="list-group-item active">3번 캠핑장</a>
			</ul>
