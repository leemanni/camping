			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="lecture">1번 캠핑장</a></li>
						<li><a href="lecture_2">2번 캠핑장</a></li>
						<li><a href="lecture_3">3번 캠핑장</a></li>
					</ul>
				</li>
			</ul>
...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<ul class="lost-group">
				<a href="lecture" class="list-group-item active">1번 캠핑장</a>
				<a href="lecture_2" class="list-group-item">2번 캠핑장</a>
...
<div class="container">
	<div class="row">
		<div class="embed-responsive embed-responsive-16by9 col-lg-12">
			<!-- 유튜브에 연결하기 -->
			<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/rYLHFMjNZjo"></iframe>		
		</div>
	</div>
</div>	
